        ...
        <div className="mt-2">
          {searching ? (
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <button
                type="button"
                onClick={onToggleIslamicCalendar}
                className="px-3 py-1.5 text-xs rounded-lg font-medium transition-opacity hover:opacity-85"
                style={{
                  backgroundColor: showIslamicCalendar ? 'var(--accent)' : 'var(--bg-card)',
                  color: showIslamicCalendar ? 'var(--bg-primary)' : 'var(--text-secondary)',
                  border: '1px solid var(--border-card)',
                }}
                aria-pressed={showIslamicCalendar}
                aria-label="Toggle Islamic calendar"
              >
                {showIslamicCalendar ? 'Hide Islamic Calendar' : 'Show Islamic Calendar'}
              </button>
            </div>
          )}
        </div>
